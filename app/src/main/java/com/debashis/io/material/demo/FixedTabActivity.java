...
import com.debashis.io.material.tablayout.FragmentContainerHelper;
...
public class FixedTabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fixedtab);
    ...
    private void initMagicIndicator4() {
        ...
        titleContainer.setDividerDrawable(new ColorDrawable() {
				...
				public int getIntrinsicWidth() {
					return UIUtil.dip2px(FixedTabActivity.this, 15);
				}
			});
