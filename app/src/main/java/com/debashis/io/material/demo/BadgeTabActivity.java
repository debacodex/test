...
import com.debashis.io.material.tablayout.buildins.commonnavigator.titles.badge.BadgePagerTitleView;
...
import com.debashis.io.material.tablayout.buildins.commonnavigator.titles.badge.BadgeAnchor;
import com.debashis.io.material.tablayout.buildins.commonnavigator.titles.badge.BadgeRule;
import com.debashis.io.material.demo.ext.titles.ScaleTransitionPagerTitleView;


public class BadgeTabActivity extends AppCompatActivity { 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_badgetab);
    ...
    private void initMagicIndicator4() {
        ...
        titleContainer.setDividerDrawable(new ColorDrawable() {
				...
				public int getIntrinsicWidth() {
					return UIUtil.dip2px(BadgeTabActivity.this, 15);
				}
			}); 
        ViewPagerHelper.bind(magicIndicator, mViewPager);
    }
